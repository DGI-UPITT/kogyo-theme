...
<body class="<?php print $classes; ?>">
  ...
  <div id="header-top-wrapper"><div id="header-top">
    <?php if ($logo): ?>
  ...
  <div id="header-wrapper-bottom">    
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($header_image): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="header-image"><img src="<?php print $header_image; ?>" alt="<?php print t('Home'); ?>" /></a>
      <?php endif; ?>
